    ...
    <Container>
      ...
      <View style={tw`mt-4 gap-4`}>
        <ActionCard
          ...
          subtitle={`Simulacro de examen completo (${examLevel}). Pon a prueba tu nivel ahora`}
          icon="school"
          tone="primary"
        ...
        <ActionCard
          ...
          onPress={() =>
            Speech.speak(
              "Welcome to PrepAI English. This is a sample listening prompt.",
              { language: "en-US" }
            )
          }
        />
      ...
      >
        ...
        <TextMuted>
          {challengeDone ? "¡Completado! ✅" : "Marca como completado cuando lo termines."}
        </TextMuted>
      </Pressable>
    </Container>
  );
